      ...
      <div className="grid gap-6 xl:grid-cols-[1.25fr_0.75fr]">
        <Card>
          <CardBody>
            ...
            <div className="flex h-72 items-end gap-3 rounded-2xl border border-studio-line/70 bg-studio-panel/52 p-4">
              {months.map((month, index) => (
                <div className="flex h-full flex-1 flex-col justify-end gap-3" key={month}>
                  <div
                    className="rounded-t-2xl bg-studio-purple/58 transition duration-300 hover:bg-studio-purple/82"
          ...
          <CardBody>
            ...
            <div className="mt-5 space-y-4">
              {[
                ...
                <div className="rounded-2xl border border-studio-line/70 bg-studio-panel/48 p-4" key={label}>
